...
ENTRY_ICONS = {
    'folder':          '\U0001f4c1',  # 📁
    'folder-shortcut': '\U0001f4c2',  # 📂
    'file':            '\U0001f4c4',  # 📄
    'file-shortcut':   '\U0001f517',  # 🔗
}
...
def is_generated_index(index_path):
    ...
    try:
        with open(index_path, 'r', encoding='utf-8', errors='replace') as fh:
            # The marker is placed near the top; reading MARKER_READ_BYTES is enough.
            return GENERATED_MARKER in fh.read(MARKER_READ_BYTES)
    except OSError:
        return False
